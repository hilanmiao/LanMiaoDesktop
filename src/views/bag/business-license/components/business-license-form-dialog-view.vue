  ...
  >
    <el-descriptions class="margin-top" :column="3" border>
      ...
      <el-descriptions-item>
        ...
        {{ form.content.businessTerm && form.content.businessTerm[0] || '' }} ~ {{ form.content.businessTerm && form.content.businessTerm[1] || '' }}
      </el-descriptions-item>
      <el-descriptions-item :span="3">
        <template slot="label">
          统一社会信用代码
        </template>
        {{ form.content.unifiedSocialCreditCode }}
      </el-descriptions-item>
      <el-descriptions-item :span="3">
        <template slot="label">
          营业执照照片
        </template>
        <el-image :src="VUE_APP_BASE_API + form.content.businessLicensePhoto1" />
      </el-descriptions-item>
    </el-descriptions>
