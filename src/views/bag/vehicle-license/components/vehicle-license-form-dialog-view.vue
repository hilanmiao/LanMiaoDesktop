  ...
  >
    <el-descriptions class="margin-top" :column="3" border>
      <el-descriptions-item :span="3">
        ...
        {{ form.content.plateNo }}
      </el-descriptions-item>
      <el-descriptions-item>
        <template slot="label">
          准驾车型
        </template>
        {{ form.content.vehicleType }}
      </el-descriptions-item>
      <el-descriptions-item>
        <template slot="label">
          品牌型号
      ...
      <el-descriptions-item>
        ...
        {{ form.content.registerDate }}
      </el-descriptions-item>
      <el-descriptions-item :span="2">
        <template slot="label">
          发证日期
        </template>
        {{ form.content.issueDate }}
      </el-descriptions-item>
      <el-descriptions-item :span="3">
        <template slot="label">
          检验记录
        </template>
        {{ form.content.testRecord }}
      </el-descriptions-item>
      <el-descriptions-item :span="3">
        <template slot="label">
          行驶证页照片
        </template>
        <el-image :src="VUE_APP_BASE_API + form.content.vehicleLicensePhoto1" />
      </el-descriptions-item>
      <el-descriptions-item :span="3">
        <template slot="label">
          行驶证副页照片
        </template>
        <el-image :src="VUE_APP_BASE_API + form.content.vehicleLicensePhoto2" />
      </el-descriptions-item>
    </el-descriptions>
